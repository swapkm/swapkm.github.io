  ...
  return (
    <Layout>
      <>
        ...
        <p>
          At swapkam.com, the privacy of our visitors is of extreme importance
          to us. This privacy policy document outlines the types of personal
          information received and collected by swapkam.com and how it is used.
        </p>
        <h2>Comments</h2>
        <p>
        ...
        <h2>Log Files</h2>
        <p>
          Like many other Web sites, swapkam.com makes use of log files. The
          ...
          stamp, referring/exit pages, and a number of clicks to analyze trends,
...
export const Head = () => (
  <SEO
    ...
    description="Learn how SwapKam protects and uses your information. Your privacy matters to us. Contact us for corrections or concerns."
  />
);
